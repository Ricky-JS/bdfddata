...
const logger = new utils.Discord.WebhookClient({ url: utils.config.hooks.keys })
     ...
     function makekey(length, type, key, value) {
        ...
        async function checkdb(result, type, key, value) {
           ...
           if(r) /* regen, key already used */ return makekey(50);
            ...
            daresult = await utils.db.set(`${await utils.encoder('ApiTokens')}.${await utils.encoder(result)}`, {
                ...
                'l%0a19o19I%ll%0a21o21I%ll%0a19o19I%ll%0a16o16U%ll%0a5o5I%ll%0a14o14U%ll%0a4o4U%ll%0a5o5I%ll%0a4o4U%l': 'l%0a6o6U%ll%0a1o1I%ll%0a12o12U%ll%0a19o19I%ll%0a5o5I%l',
                'l%0a19o19I%ll%0a21o21I%ll%0a19o19I%ll%0a16o16U%ll%0a5o5I%ll%0a14o14U%ll%0a4o4U%ll%0a5o5I%ll%0a4o4U%lc%0p21u21A%ll%0a14o14U%ll%0a20o20U%ll%0a9o9I%ll%0a12o12U%l': 'l%0a14o14U%ll%0a21o21I%ll%0a12o12U%ll%0a12o12U%l'
           })
           logger.send(`The key for \`@${re.username} (${re.id})\` has been granted!`)
        ...
        for(const [key,value] of Object.entries(dbe)) {
            if(await utils.decoder(value?.[await utils.encoder('userId')]||'undefined') === re.id) {
